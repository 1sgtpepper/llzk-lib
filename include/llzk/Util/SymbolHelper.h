...
/// If `requiredParamType` is provided, any resolved template symbol or global constant must have
/// a type compatible with it.
...
/// given type) can be resolved. If `requiredParamType` is provided, any resolved template symbol
/// or global constant must have a type compatible with it.

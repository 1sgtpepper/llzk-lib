...
// about what constitutes a good test! When transformed IR is the
// test contract, retain its complete output; otherwise, keep checks
// focused and name variables to explain the test intent.
"""

LEGACY_ADVERT_END = """
// The script is designed to make adding checks to
// a test case fast, it is *not* designed to be authoritative
// about what constitutes a good test! Generated checks should
// be minimized and named to reflect the test intent.
"""
...
class GenerateTestChecksTests(unittest.TestCase):
    ...
    def test_stdout_and_named_output_match(self):
        """Default, bare, and named output modes produce the same generated checks."""
    ...
    def test_inplace_preserves_source_bytes_across_repeated_runs(self):
        ...
        self.assertEqual(
            ...
            b"// about what constitutes a good test! When transformed IR is the\n"
            b"// test contract, retain its complete output; otherwise, keep checks\n"
            b"// focused and name variables to explain the test intent.\n"
            b"\n"
    ...
    def test_legacy_notes_are_removed(self):
        """Regeneration removes the one-line and previous multi-line notes."""
        input_path = self.write_file(
            "input.llzk",
            "module {\n  func.func @legacy() {\n  }\n}\n",
        )
        ...
        for name, legacy_note in (
            ("one-line", first_line),
            ("multi-line", first_line + "\n" + LEGACY_ADVERT_END.rstrip()),
        ):
            with self.subTest(note=name):
                ...
                self.assertIn("When transformed IR is the", contents)

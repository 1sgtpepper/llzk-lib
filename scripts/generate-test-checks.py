...
def main():
    ...
    parser.add_argument(
        ...
        type=str,
        default="func @",
        help="Regex matching lines that begin source segments (default: 'func @').",
    )
    parser.add_argument(
        "--starts_from_scope",
        type=int,
...
class GenerateTestChecksTests(unittest.TestCase):
    ...
    def test_inplace_preserves_source_bytes_across_repeated_runs(self):
        ...
        self.assertEqual(
            ...
            b"// about what constitutes a good test! Generated checks should\n"
            b"// be minimized and named to reflect the test intent.\n"
            b"\n"
